...
@Entity({ name: 'stat_aggregate_daily' })
@Unique('uq_stat_aggregate_daily_dimensions', [
  'date',
  'organizationId',
  'metricCode',
  'dimensionPlatform',
...
@Index('idx_stat_aggregate_daily_date', ['date'])
@Index('idx_stat_aggregate_daily_org_date', ['organizationId', 'date'])
@Index('idx_stat_aggregate_daily_metric_date', ['metricCode', 'date'])
export class StatAggregateDailyEntity {
